...
public class Season {
    ...
    public  void overlaps(Season newSeason) throws training.ideas.java.decisions.OverlappingSeasonException {
        if ( (newSeason.startDate.compareTo(endDate)<=0 ) && (newSeason.endDate.compareTo(startDate)>=0) ) {
            throw new training.ideas.java.decisions.OverlappingSeasonException(newSeason.startDate,newSeason.endDate,startDate,endDate);
        }
    }
